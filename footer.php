...
<footer >
    ...
    <div class="container-fluid bottomFooter">
        <div class="container">
            <div class="row d-flex align-items-end pb-0">
                <div class="col col-6">
            ...
            <div class="row pb-0">
                ...
                <div class="col col-3 text-right hoursAddress">
                    <span><strong>Sales Office</strong></span><br/>
                    <span>30 Battery Street, Suite 1B</span><br/>
                    <span>Boston, MA 02109</span>
                </div>
                <div class="col col-3 text-right hoursAddress">
                    <span><strong>Head Office</strong></span><br/>
                    <span>7 Box Car Blvd</span><br/>
